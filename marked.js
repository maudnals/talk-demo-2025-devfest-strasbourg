...
(function (g, f) {
  ...
  function () {
    ...
    var we = (l, e) => {
        for (var t in e) G(l, t, { get: e[t], enumerable: !0 });
      },
      ye = (l, e, t, n) => {
    ...
    var Pe = (l) => ye(G({}, "__esModule", { value: !0 }), l);
    var kt = {};
    we(kt, {
      Hooks: () => S,
      Lexer: () => x,
    ...
    var m = {
      ...
      je = d(he, "u").replace(/punct/g, D).getRegex(),
      Qe = d(he, "u").replace(/punct/g, ce).getRegex(),
      de =
        "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",
      Ue = d(de, "gu")
        .replace(/notPunctSpace/g, pe)
        .replace(/punctSpace/g, X)
        .replace(/punct/g, D)
        .getRegex(),
      Ke = d(de, "gu")
        .replace(/notPunctSpace/g, Ne)
      ...
      B = { normal: W, gfm: Be, pedantic: qe },
      M = { normal: J, gfm: F, breaks: rt, pedantic: nt };
    var st = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
                ...
                if (
                  ...
                  this.options.pedantic
                    ? ((h = h.replace(
                      ...
                      (I = h))
                    : (I = h.replace(this.rules.other.tabCharGlobal, "    ")),
                  ne.test(h) ||
                    re.test(h) ||
                    be.test(h) ||
                    H.test(h) ||
...
`),
            ...
            i.loose ||
              (o
                ? (i.loose = !0)
                : this.rules.other.doubleBlankLine.test(c) && (o = !0));
            let O = null,
              ee;
            this.options.gfm &&
              ((O = this.rules.other.listIsTask.exec(p)),
              O &&
                ((ee = O[0] !== "[ ] "),
                (p = p.replace(this.rules.other.listReplaceTask, "")))),
              i.items.push({
                type: "list_item",
                raw: c,
                task: !!O,
          ...
          for (let u = 0; u < i.items.length; u++)
            if (
              ...
              let c = i.items[u].tokens.filter((g) => g.type === "space"),
                p =
                  c.length > 0 &&
                  c.some((g) => this.rules.other.anyLine.test(g.raw));
              i.loose = p;
            }
          if (i.loose)
        ...
        return (n, r) => {
          ...
          if (
            ...
            return (async () => {
              ...
              s.walkTokens &&
                (await Promise.all(this.walkTokens(p, s.walkTokens)));
              let h = await (s.hooks
          ...
          try {
            ...
            let u = (
              s.hooks ? s.hooks.provideLexer() : e ? x.lex : x.lexInline
            )(n, s);
            s.hooks && (u = s.hooks.processAllTokens(u)),
              s.walkTokens && this.walkTokens(u, s.walkTokens);
            let p = (
              s.hooks ? s.hooks.provideParser() : e ? b.parse : b.parseInline
            )(u, s);
